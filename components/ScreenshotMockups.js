...
export default function ScreenshotMockups({ onDemo }) {
  return <section className="section mockup-section" id="demo"><div className="shell">
    ...
    <div className="mockups">
      <div className="mock-frame small"><div className="browser-dots">● ● ●</div><div className="mock-body"><small>01 — SET YOUR PRACTICE</small><h3>Ramen Shop</h3><div className="mock-option selected">Guided <CheckCircle2/></div><div className="mock-option">Natural</div><div className="mock-option">Challenge</div><span className="mock-label">VOICE-FIRST SUPPORT</span><div className="mock-pills"><b>Ask naturally</b><b>Agent helps</b></div><button>Start conversation →</button></div></div>
