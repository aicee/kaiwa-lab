...
export function validateFeedbackReport(value, options = {}) {
  ...
  const misunderstoodLanguage = validateArray(value.misunderstoodLanguage, 3, (item) => validateStringObject(item, ["japanese", "reading", "romaji", "english", "learnerContext", "explanation"]));
